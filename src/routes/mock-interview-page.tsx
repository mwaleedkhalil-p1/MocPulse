  ...
  return (
    <div className="flex flex-col w-full gap-8 py-5">
      ...
      <div className="w-full flex gap-4">
        <Alert className="flex-1 bg-sky-100 border border-sky-200 p-4 rounded-lg flex items-start gap-3">
        ...
        <button
          ...
          className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors flex items-center gap-2 self-start"
        >
          View Feedback
        </button>
      </div>
